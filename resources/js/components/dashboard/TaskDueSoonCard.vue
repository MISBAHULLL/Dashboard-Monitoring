...
<template>
    ...
    >
        ...
        <div class="flex flex-1 flex-col items-center justify-center gap-1.5 px-6 py-3 text-center">
            <span
            ...
            <div class="max-w-[360px]">
                <h3 class="font-['Solway',serif] text-[16px] font-bold leading-tight text-[#0b2a6b] dark:text-tm-navy-pale">
                    Semua deadline masih aman
                </h3>
                <p
            ...
            <ActionTooltip v-if="viewAllLink" label="Buka daftar task due soon" side="bottom">
            <Link
                :href="viewAllLink"
